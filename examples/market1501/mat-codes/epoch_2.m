...
score_1L = importdata('../datamat/train.1L.epoch2.score.mat');
score_1  = importdata('../datamat/train.1.epoch2.score.mat');
...
for label = 1:numel(unique_label)
	count_per_class(label) = 2*numel(find(label_1==label));
...
%% Normalize            : accuracy: 0.90692  ||  un_select : 14 || zero_acc : 46


list_file = fopen('../lists/train.epoch.3', 'w');
